...
@section('content')
	...
	<section class="container pb-5 mt-5">
    	<h2 class="h4 block-title mb-4 text-center">Privacy and Confidentiality</h2>
    	<div class="row pt-3">
    		<div class="col-md-12 col-12 text-left">
    			<p>Welcome to the Boibhandar.com website (the "Site") operated by Boibhandar Ltd. We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy.</p>
    			...
    			<h3 class="h4 text-left block-title">Data that we collect</h3>
				...
				<h3 class="h6">Other uses of your Personal Information</h3>
				...
				<h3 class="h6">Third Parties and Links</h3>
				...
				<h3 class="h4 text-left block-title">Cookies</h3>
				...
				<h3 class="h4 text-left block-title">Security</h3>
				...
				<h3 class="h4 text-left block-title">Your rights</h3>
